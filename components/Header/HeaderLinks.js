    ...
    <List className={classes.list}>
      <ListItem className={classes.listItem}>
        <CustomDropdown
          ...
          buttonIcon={Apps}
          dropdownList={[
            <Link href="/wallOfPots">
              <a className={classes.dropdownLink}>Wall of Pots</a>
            </Link>,
            <a
              href="/timelineMap"
              target="_blank"
      ...
      <ListItem className={classes.listItem}>
        <Button
          ...
          className={classes.navLink}
        >
          <Home className={classes.icons} /> Main Site
        </Button>
      </ListItem>
      <ListItem className={classes.listItem}>
      ...
      <ListItem className={classes.listItem}>
        ...
        >
          <Button
            color="transparent"
            href="https://www.instagram.com/arizonastatemuseum/"
            target="_blank"
            className={classes.navLink}
          >
