    ...
    <div className={classes.section}>
      <GridContainer justify="center">
        <GridItem xs={12} sm={12} md={8}>
          <h2 className={classes.title} style={{textAlign:'left', color:'black', fontFamily:'serif'}}>Enter the World of Southwestern Native Pottery</h2>
      ...
      <div>
        <GridContainer>
          <GridItem xs={12} sm={12} md={6}>
            <InfoArea
              title="Wall of Pots"
              description="Explore 2000 years of history through 160 pots and learn about indigenous "
          ...
          <h5 className={classes.description} style={{textAlign:'left', color:'black', fontFamily:'serif'}}>
          We respectfully acknowledge the University of Arizona and Arizona State Museum is on the land and territories of Indigenous peoples. Today, Arizona 
